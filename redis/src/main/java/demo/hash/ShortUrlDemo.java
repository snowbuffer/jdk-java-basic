...
public class ShortUrlDemo {
    ...
    private Jedis jedis = new Jedis("10.0.7.71", 16379);
    ...
    public String getShortUrl(String url) {
        ...
        if (!jedis.hexists("short_url_access_count", shortUrl)) {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(51167890046L / 36);
        ShortUrlDemo demo = new ShortUrlDemo();

        String shortUrl = demo.getShortUrl("http://redis.com/index.html111111");
