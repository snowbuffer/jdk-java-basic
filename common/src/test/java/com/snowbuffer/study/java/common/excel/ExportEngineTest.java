...
import com.snowbuffer.study.java.common.excel.out.ExportConfig;
import com.snowbuffer.study.java.common.excel.out.ExportEngine;
import com.snowbuffer.study.java.common.excel.out.ExportHandler;
...
public class ExportEngineTest {
    ...
    public static void main(String[] args) {
        ...
        SheetWorker<CourseJoinPreVO> sheetWorker
                = new SheetWorker<>(1, "abc", preVOParam, new Function<BasePageQuery, MelotPageResult<?>>() {
            @Override
