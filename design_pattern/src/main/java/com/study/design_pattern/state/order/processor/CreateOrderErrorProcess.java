...
//  创建订单失败。订单由不可见状态到废单状态
@Component
@OrderProcessor
public class CreateOrderErrorProcess extends AbstractOrderProcessor {

    public CreateOrderErrorProcess() {
        setOrderAction(OrderAction.DO_CREATE_ERROR);
    }
